...
def sample_lesson(sample_day):
    ...
    lesson = Lesson(
        ...
        homework=Homework(
            ...
            links=[
                Link(original_url="http://example.com", destination_url="http://final.com")
            ],
            attachments=[
                Attachment(filename="math.pdf", url="/files/math.pdf")
            ]
        )
    )
...
def test_create_announcement(repository, sample_schedule, sample_day, sample_announcement):
