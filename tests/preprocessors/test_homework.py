...
from src.crawler.schedule.preprocessors.homework import (
...
def test_combine_homework_texts():
    ...
    assert result == "G. 140. lpp., 42., 44*. uzd. Prezentācija stundai: Darba lapa. Kāda ir Latvijas valsts?"
...
def test_preprocess_homework():
    ...
    assert result["links"][0]["destination_url"] == "https://www.uzdevumi.lv/TestWork/Info/4649268"
    ...
    homework_data = {
        ...
        "links": [
            {"url": "https://prezi.com/view/AenZE9InlMncuUlPQvAZ/"}
        ],
        "attachments": []
    }
    result = preprocess_homework(homework_data)
